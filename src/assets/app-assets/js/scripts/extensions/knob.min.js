$(document).ready(function() {
    function i() {
        var h = $(".second"),
            ...
            o = n.getMinutes(),
            a = n.getHours();
        h.val(r).trigger("change"), s.val(o).trigger("change"), e.val(a).trigger("change"), t = setTimeout(function() {
            i()
        }, 1e3)
    }
    var h = !1;
    "rtl" == $("html").data("textdirection") && (h = !0), $(".knob").knob({
        rtl: h,
        change: function(t) {},
        release: function(t) {},
        cancel: function() {},
    ...
    var s, e = 0,
        ...
        a = $(".ival"),
        g = function() {
            r++, o.show().html("+").fadeOut(), a.html(r)
        },
        c = function() {
            r--, o.show().html("-").fadeOut(), a.html(r)
        };
    $(".infinite").knob({
        ...
        stopper: !1,
        change: function() {
            s > this.cv ? e ? (c(), e = 0) : (e = 1, n = 0) : s < this.cv && (n ? (g(), n = 0) : (n = 1, e = 0)), s = this.cv
        }
    })
});